...
class CWMachine(StateMachine):
    ...
    def on_exit_dot(self):
        ...
        self.redLight.off()  # Turn the Red LED off
    ...
    def toggleMessage(self):
        ...
        self.activeMessage = "OK" if self.activeMessage == "SOS" else "SOS"
        ...
        for word in wordList:
            ...
            for char in word:
                ...
                for x in morse:
                    ...
                    if x == ".":
                        self.doDot()   # transition to dot
                    elif x == "-":
                        self.doDash()  # transition to dash
                    ...
                    if morseCounter < lenMorse:
                        self.doDDP()  # pause between dots/dashes, returns to off
