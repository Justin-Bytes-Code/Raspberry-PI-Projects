...
while repeat:
    try:
        ...
        for dutyCycle in range(0, 101, 5):  # fade in
        ...
        for dutyCycle in range(100, -1, -5):  # fade out
            pwm18.ChangeDutyCycle(dutyCycle)
            time.sleep(0.1)
